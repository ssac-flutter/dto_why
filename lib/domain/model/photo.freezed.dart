...
abstract class $PhotoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String url, String tags});
}
...
class _$_Photo implements _Photo {
  const _$_Photo({required this.url, required this.tags});
  ...
  @override
  String toString() {
    return 'Photo(url: $url, tags: $tags)';
  }
...
abstract class _Photo implements Photo {
  const factory _Photo(
      {required final String url, required final String tags}) = _$_Photo;
